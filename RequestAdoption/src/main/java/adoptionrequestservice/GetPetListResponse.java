...
@XmlRootElement(name = "getPetListResponse", namespace = "http://www.furryaide/ws/AdoptionRequestService")
public class GetPetListResponse {

    @XmlElement(namespace = "http://www.furryaide/ws/AdoptionRequestService")
