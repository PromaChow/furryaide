...
@XmlRootElement(name = "listQuestionsResponse", namespace = "http://www.furryaide/ws/QuestionnaireService")
public class ListQuestionsResponse {

    @XmlElement(name = "Questions", namespace = "http://www.furryaide/ws/QuestionnaireService")
